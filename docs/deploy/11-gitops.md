...
This reference implementation includes Microsoft Defender for Containers as a solution for helping you secure your containers and runtime environment. Microsoft Defender for Containers, provides [security alerts](https://docs.microsoft.com/azure/defender-for-cloud/alerts-reference#alerts-k8scluster) on the cluster level and on the underlying cluster nodes by monitoring both the API server activity and the behavior of the workloads themselves.   
